...
import StatutoryCertificatesListPage from "./StatutoryCertificatesListPage";

export default function StatutoryCertificatesListPageWrapper() {
  return (
