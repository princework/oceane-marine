...
import CidFormPage from "./form/CidFormPage";
import CidListPage from "./list/CidListPage";
        ...
        <div className="w-full mx-auto py-4 sm:py-6 md:py-10 space-y-4 sm:space-y-6 px-3 sm:px-4">
          ...
          >
            ...
            <div className="flex-1 min-w-0 flex flex-col items-center text-center w-full md:w-auto">
              ...
              <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-white">CID</h1>
            </div>
            ...
            <CidFormPage
              onSuccess={() => {
                ...
                if (typeof window !== "undefined") {
                  window.dispatchEvent(new Event("refreshCid"));
                }
              }}
            />
          )}
          {activeTab === "list" && (
            <CidListPage onRefresh={() => setActiveTab("list")} />
          )}
        </div>
      </div>
    </div>
