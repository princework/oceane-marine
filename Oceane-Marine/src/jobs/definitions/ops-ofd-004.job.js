import STSChecklist4AF from "../../lib/mongodb/models/operation-sts-checklist/OPS-OFD-004.js";
import Operation from "../../lib/mongodb/models/sts-documentation/StsOperation.js";
import { generateOpsOfd004Doc } from "../services/pdf/OPS-OFD-004.js";
import { getPdfStoragePath } from "../services/pdf/pdfStorage.js";
import fs from "node:fs";
import path from "node:path";

const DOCUMENT_TYPE = "OPS-OFD-004";

export function defineOpsOfd004Job(agenda) {
    agenda.define("generate-ops-ofd-004", async (job) => {
        ...
        try {
            console.log("🚀 Starting OPS-OFD-004 document generation job", { checklistId, operationRef });
            ...
            // ==================== FETCH CHECKLIST ====================
            const checklist = await STSChecklist4AF.findById(checklistId).lean();
            if (!checklist) {
            ...
            await generateOpsOfd004Doc(checklist, fullPath);
