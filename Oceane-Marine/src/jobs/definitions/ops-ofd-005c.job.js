import STSChecklist5C from "../../lib/mongodb/models/operation-sts-checklist/OPS-OFD-005C.js";
import Operation from "../../lib/mongodb/models/sts-documentation/StsOperation.js";
import { generateOpsOfd005CDoc } from "../services/pdf/OPS-OFD-005C.js";
import { getPdfStoragePath } from "../services/pdf/pdfStorage.js";
import fs from "node:fs";
import path from "node:path";

const DOCUMENT_TYPE = "OPS-OFD-005C";

export function defineOpsOfd005CJob(agenda) {
    agenda.define("generate-ops-ofd-005c", async (job) => {
        ...
        try {
            console.log("🚀 Starting OPS-OFD-005C document generation job", { checklistId, operationRef });
            ...
            // ==================== FETCH CHECKLIST ====================
            const checklist = await STSChecklist5C.findById(checklistId);
            if (!checklist) {
            ...
            await generateOpsOfd005CDoc(checklist, fullPath);
