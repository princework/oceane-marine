import STSChecklist3A3B from "../../lib/mongodb/models/operation-sts-checklist/OPS-OFD-003.js";
import Operation from "../../lib/mongodb/models/sts-documentation/StsOperation.js";
import { generateOpsOfd003Doc } from "../services/pdf/OPS-OFD-003.js";
import { getPdfStoragePath } from "../services/pdf/pdfStorage.js";
import fs from "node:fs";
import path from "node:path";

const DOCUMENT_TYPE = "OPS-OFD-003";

export function defineOpsOfd003Job(agenda) {
    agenda.define("generate-ops-ofd-003", async (job) => {
        ...
        try {
            console.log("🚀 Starting OPS-OFD-003 document generation job", { checklistId, operationRef });
            ...
            // ==================== FETCH CHECKLIST ====================
            const checklist = await STSChecklist3A3B.findById(checklistId);
            if (!checklist) {
            ...
            await generateOpsOfd003Doc(checklist, fullPath);
