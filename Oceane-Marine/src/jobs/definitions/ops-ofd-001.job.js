import STSChecklistOne from "../../lib/mongodb/models/operation-sts-checklist/OPS-OFD-001.js";
import Operation from "../../lib/mongodb/models/sts-documentation/StsOperation.js";
import { generateOpsOfd001Doc } from "../services/pdf/OPS-OFD-001.js";
import { getPdfStoragePath } from "../services/pdf/pdfStorage.js";
import fs from "node:fs";
import path from "node:path";

const DOCUMENT_TYPE = "OPS-OFD-001";

export function defineOpsOfd001Job(agenda) {
    agenda.define("generate-ops-ofd-001", async (job) => {
        ...
        try {
            console.log("🚀 Starting OPS-OFD-001 document generation job", { checklistId, operationRef });
            ...
            // ==================== FETCH CHECKLIST ====================
            const checklist = await STSChecklistOne.findById(checklistId);
            if (!checklist) {
            ...
            await generateOpsOfd001Doc(checklist, fullPath);
