import STSChecklist5 from "../../lib/mongodb/models/operation-sts-checklist/OPS-OFD-005.js";
import Operation from "../../lib/mongodb/models/sts-documentation/StsOperation.js";
import { generateOpsOfd005Doc } from "../services/pdf/OPS-OFD-005.js";
import { getPdfStoragePath } from "../services/pdf/pdfStorage.js";
import fs from "node:fs";
import path from "node:path";

const DOCUMENT_TYPE = "OPS-OFD-005";

export function defineOpsOfd005Job(agenda) {
    agenda.define("generate-ops-ofd-005", async (job) => {
        ...
        try {
            console.log("🚀 Starting OPS-OFD-005 document generation job", { checklistId, operationRef });
            ...
            // ==================== FETCH CHECKLIST ====================
            const checklist = await STSChecklist5.findById(checklistId).lean();
            if (!checklist) {
            ...
            await generateOpsOfd005Doc(checklist, fullPath);
