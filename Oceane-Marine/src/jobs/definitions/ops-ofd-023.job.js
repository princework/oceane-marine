import RecordOfWorkHours from "../../lib/mongodb/models/operation-sts-checklist/OPS-OFD-023.js";
import Operation from "../../lib/mongodb/models/sts-documentation/StsOperation.js";
import { generateOpsOfd023Doc } from "../services/pdf/OPS-OFD-023.js";
import { getPdfStoragePath } from "../services/pdf/pdfStorage.js";
import fs from "node:fs";
import path from "node:path";

const DOCUMENT_TYPE = "OPS-OFD-023";

export function defineOpsOfd023Job(agenda) {
    agenda.define("generate-ops-ofd-023", async (job) => {
        ...
        try {
            console.log("🚀 Starting OPS-OFD-023 document generation job", { checklistId, operationRef });
            ...
            // ==================== FETCH FORM ====================
            const form = await RecordOfWorkHours.findById(checklistId).lean();
            if (!form) {
            ...
            await generateOpsOfd023Doc(form, fullPath);
