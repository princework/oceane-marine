/**
 * One-time script to assign hrRole to existing users.
 *
 * Usage:
 *   node scripts/seed-hr-roles.js
 *
 * Make sure MONGODB_URI is available in .env.local (or set inline).
 */
...
/** Same keys as seed-operations-roles — adjust per team */
const ROLE_MAP = {
...
async function main() {
  ...
  console.log(`Set ${remaining.modifiedCount} remaining users to 'viewer' (hrRole)`);
